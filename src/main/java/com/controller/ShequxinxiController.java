...
public class ShequxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShequxinxiEntity shequxinxi,
		...
		if(tableName.equals("kehu")) {
			shequxinxi.setYonghuming((String)request.getSession().getAttribute("username"));
		}
    ...
    public R vote(@PathVariable("id") String id,String type){
        ShequxinxiEntity shequxinxi = shequxinxiService.selectById(id);
        if(type.equals("1")) {
        	shequxinxi.setThumbsupnum(shequxinxi.getThumbsupnum()+1);
        } else {
        	shequxinxi.setCrazilynum(shequxinxi.getCrazilynum()+1);
        }
