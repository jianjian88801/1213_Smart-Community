...
public class ZhoubianfuwuController {
    ...
    public R save(@RequestBody ZhoubianfuwuEntity zhoubianfuwu, HttpServletRequest request){
    	zhoubianfuwu.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ZhoubianfuwuEntity> wrapper = new EntityWrapper<ZhoubianfuwuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = zhoubianfuwuService.selectCount(wrapper);
